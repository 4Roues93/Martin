                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="10" cellpadding="0">
                    ...
                    <tr>
					  ...
					  <div id="link">
                        <tr>
                          Bienvenue dans la partie Ajout/Suppression de Tablatures :<br><br>
						  
						  <a href="tab.php" style="color:white;">Ajout de Tablatures </a><br>
						  <a href="tabSupp.php" style="color:white;">Suppression de Tablatures</a>
